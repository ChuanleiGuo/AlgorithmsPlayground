public class TestOverlappingCycle {
  // @include
  public static ListNode<Integer> overlappingLists(ListNode<Integer> L1,
                                                   ListNode<Integer> L2) {
    // Store the start of cycle if any.
    ListNode<Integer> root1 = TestForCyclicity.hasCycle(L1);
    ListNode<Integer> root2 = TestForCyclicity.hasCycle(L2);

    if (root1 == null && root2 == null) {
      // Both lists don't have cycles.
      return TestOverlappingList.overlapping(L1, L2);
    ...
    if (stem1Length > stem2Length) {
      L1 = TestOverlappingList.advanceByK(stem1Length - stem2Length, L1);
    } else {
      L2 = TestOverlappingList.advanceByK(stem2Length - stem1Length, L2);
    }
