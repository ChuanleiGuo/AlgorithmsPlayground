...
public class MergeSortedArrays {
    private static class ArrayEntry {
        ...
        public Integer arrayIdx;

        public ArrayEntry(Integer value, Integer arrayIdx) {
            this.value = value;
    ...
    public static List<Integer> mergeSortedArrays(List<List<Integer>> sortedArrays) {
        ...
        PriorityQueue<ArrayEntry> minHeap = new PriorityQueue<>(iters.size(), new Comparator<ArrayEntry>() {
            @Override
        ...
        while (!minHeap.isEmpty()) {
            ...
            Integer idx = headEntry.arrayIdx;
            if (iters.get(idx).hasNext()) {
                minHeap.add(new ArrayEntry(iters.get(idx).next(), idx));
            }
        }
        return result;
    }
    ...
    private static void simpleTest() {
        ...
        List<Integer> golden = Arrays.asList(1, 2, 2, 3, 5, 10, 12, 100, Integer.MAX_VALUE);
        check(S, ans, golden);
        ...
        S = Arrays.asList(new ArrayList<Integer>(), Arrays.asList(1), Arrays.asList(2));
        ans = mergeSortedArrays(S);
